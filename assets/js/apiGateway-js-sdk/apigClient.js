...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://4bo04a1soh.execute-api.us-east-1.amazonaws.com/v1';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Content-Type', 'photokey', 'x-amz-meta-customLabels'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['photokey', 'x-amz-meta-customLabels']),
            body: body
        };
